...
<div class=" h-100 w-100">
    <div class="fondo-login container-fluid px-2 h-100 w-100 d-flex justify-content-center">
        <div class="row p-0  container-xl m-0 mt-5 h-75 align-content-around justify-content-around">
            ...
            <c:forEach items="${listaSuscripcion}" var="curso" varStatus="status">
            <div class="col-12 col-md-5 p-5 pb-0 p-md-1 bg-white rounded-3 mx-3">
                <form class="m-5 mb-3 mx-2">
                    ...
                    <!-- Modal 1-->
                    <c:if test="${status.first}">
                    <form:form action="contratar-curso" method="POST" modelAttribute="datosLogin">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">${curso.descripcion}</h5>
                                    ...
                                    <div class="modal-footer">
                                        <form:input path="id" type="hidden" id="id" value="${alumno.id}" class="form-control"/>
                    ...
                    <c:if test="${status.last}">
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">${curso.descripcion}</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
